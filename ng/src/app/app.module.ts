/*  ---------------------------------------------------------------------------
    ...
    - DnnInterceptor: this ensures all http-requests will have the necessary DNN headers
...
@NgModule({
  ...
  imports: [
    ...
    // Important: don't load sub-modules here if you want lazy-loading to work
    ...
    // TODO: Move these components to app component
    TitleComponent,
    NavigationComponent,
  ],
  providers: [],
